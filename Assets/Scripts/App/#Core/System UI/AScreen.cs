...
namespace Core.Screen
{
    ...
    /*
    [Serializable]
    public abstract class AScreen : AComponent, IConfigurable, ICacheable
    {
        ...
        /*
            ...
            {
                if (IsActivated == true)
                    return new TaskResult(true, Send("The instance was already activated. The current loading has been aborted!", LogFormat.Warning));
